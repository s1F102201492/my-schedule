...
import { Box, Button, Chip, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle, FormGroup, MenuItem, Select, SelectChangeEvent, Switch, TextField } from '@mui/material'
...
const editTodo = async (
    ...
    color: string) => {
      ...
      const res = await fetch(`/api/todo/${id}`,
       { method: "PUT",
         body: JSON.stringify({id, title, description, continuedays, checkedDates, startdate, enddate, interval, color}),
         headers: {
...
const Edit: React.FC<oneTodo> = ({ id, todo }) => {
    ...
    // 曜日を選んだ場合
      const [selectedDays, setSelectedDays] = useState<string[]>(initialinterval() as string[])
